...
var ASM_CONSTS = {
 ...
 73816: ($0) => { if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } },  
 73899: () => { if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; } },  
 73968: () => { return window.innerWidth; },  
 73998: () => { return window.innerHeight; }
};
